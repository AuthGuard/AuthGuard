...
public interface ApplicationsService extends IdempotentCrudService<AppBO> {
    ...
    Uni<AppBO> grantPermissions(long id, List<PermissionBO> permissions, String domain);
    Uni<AppBO> revokePermissions(long id, List<PermissionBO> permissions, String domain);

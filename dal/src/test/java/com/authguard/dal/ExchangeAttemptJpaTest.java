...
public class ExchangeAttemptJpaTest {
    ...
    void getByEntityId() {
        ...
        assertThat(retrieved).containsExactly(firstAttempt, secondAttempt);
    }
    ...
    void getByEntityIdFromTimestamp() {
        ...
        final List<ExchangeAttemptDO> retrieved = query.getResultList();
        assertThat(retrieved).containsExactly(secondAttempt);
    }
    ...
    void getByEntityIdAndExchangeFromTimestamp() {
        ...
        final List<ExchangeAttemptDO> retrieved = query.getResultList();
        assertThat(retrieved).containsExactly(firstAttempt);
    }
}

...
@TokenExchange(from = "otp", to = "samlResponse")
public class OtpToSamlResponse implements Exchange {
    ...
    @Inject
    public OtpToSamlResponse(final OtpVerifier otpVerifier, final AccountsService accountsService,
    ...
    public Uni<AuthResponseBO> exchange(final AuthRequestBO request) {
        ...
        if (!SamlConditionalAuthn.satisfiesRequestedContext(authnRequest, "otp")) {
